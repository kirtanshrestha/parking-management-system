                                    ...
                                    <div class="chart-grid">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-footer">
                                                <p style="font-size:200%; ; text-align:center; margin:0;">$ {{$totalcharge}}</p>

                                                <p style="font-size:150% ; text-align: center; margin:0; color:grey;">Total
                                                    Revenue</p>
                                            </div>
                                        </div>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    flatpickr("#monthSelector", {
                        plugins: [new monthSelectPlugin({
                            shorthand: true, // Display shorthand month names
                            dateFormat: "Y-m", // Format for the input value
